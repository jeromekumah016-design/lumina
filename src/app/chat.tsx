      ...
      <SynthwaveBackground>
        <View style={{ flex: 1 }}>
              ...
              return (
                <View
                  ...
                  style={{
                    ...
                    maxWidth: '80%',
                    marginBottom: 12,
                    backgroundColor: isMe ? 'rgba(0,20,50,0.85)' : RETRO_COLORS.cardBg,
                    borderWidth: 2,
                    borderColor: isMe ? RETRO_COLORS.neonCyan : RETRO_COLORS.neonMagenta,
                    shadowColor: isMe ? RETRO_COLORS.neonCyan : RETRO_COLORS.neonMagenta,
          ...
          <View style={{
            ...
            backgroundColor: 'rgba(4,0,15,0.97)',
            alignItems: 'center',
