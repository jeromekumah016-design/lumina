...
const mockPropertiesByCity: Record<string, Property[]> = {
  ...
  // ─── Coastal Demo dataset (mockup spec — 6 iconic CA/HI properties) ──────
  'Coastal Demo': [
    {
      id: 'coast-1',
      rank: 1,
      ...
      pricePerPerson: 127,
      location: { city: 'Laguna Beach', country: 'CA' },
      keepVotes: 18,
      eliminateVotes: 3,
      commentCount: 6,
      myVote: null,
    ...
    },
    {
      ...
      title: 'Pineview Retreat',
      pricePerPerson: 98,
      location: { city: 'Lake Tahoe', country: 'CA' },
      keepVotes: 14,
      eliminateVotes: 4,
      commentCount: 4,
      myVote: null,
    ...
    },
    {
      ...
      title: 'Casa Del Sol',
      pricePerPerson: 112,
      location: { city: 'Santa Barbara', country: 'CA' },
      keepVotes: 22,
      eliminateVotes: 5,
      commentCount: 8,
      myVote: null,
    ...
    },
    {
      ...
      title: 'Oceanfront Haven',
      pricePerPerson: 135,
      location: { city: 'Malibu', country: 'CA' },
      keepVotes: 16,
      eliminateVotes: 7,
      commentCount: 5,
      myVote: null,
    ...
    },
    {
      id: 'coast-5',
      rank: 5,
      imageUrl: 'https://images.unsplash.com/photo-1540541338537-1a43a0c3af0b?w=800',
      title: 'Tropical Hideaway',
      pricePerPerson: 89,
      location: { city: 'Hawaii', country: 'HI' },
      keepVotes: 20,
      eliminateVotes: 6,
      commentCount: 9,
      myVote: null,
    ...
    },
    {
      id: 'coast-6',
      rank: 6,
      imageUrl: 'https://images.unsplash.com/photo-1615880484746-a134be9a6ecf?w=800',
      title: 'Desert Oasis',
      pricePerPerson: 104,
      location: { city: 'Palm Springs', country: 'CA' },
      keepVotes: 11,
      eliminateVotes: 8,
      commentCount: 3,
      myVote: null,
...
const seedComments: Record<string, Record<string, Comment[]>> = {
  ...
  'Coastal Demo': {
    'coast-1': [
      { id: 'cd1', author: 'Emma', text: 'The ocean views here are absolutely breathtaking!', timestamp: '1h ago' },
      { id: 'cd2', author: 'Liam', text: 'Private beach access is a major win.', timestamp: '45m ago' },
    ],
    'coast-3': [
      { id: 'cd3', author: 'Sophia', text: 'Loved the Spanish architecture and the garden.', timestamp: '2h ago' },
    ],
    'coast-5': [
      { id: 'cd4', author: 'Noah', text: 'This tropical vibe is exactly what I needed.', timestamp: '30m ago' },
      { id: 'cd5', author: 'Olivia', text: 'Lush greenery everywhere — feels like paradise.', timestamp: '15m ago' },
    ],
  },
};
